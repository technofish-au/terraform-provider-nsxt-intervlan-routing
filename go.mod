module github.com/ianbrown78/terraform-provider-nsxt-intervlan-routing
...
require (
	...
	github.com/hashicorp/terraform-provider-scaffolding-framework v0.0.0-20250801112927-07b4fe567f88
